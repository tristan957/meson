...
base_options: 'KeyedOptionDictType' = {
    OptionKey('b_pch'): coredata.UserBooleanOption('Use precompiled headers', True, yielding=True),
    OptionKey('b_lto'): coredata.UserBooleanOption('Use link time optimization', False, yielding=True),
    OptionKey('b_lto_threads'): coredata.UserIntegerOption('Use multiple threads for Link Time Optimization', (None, None, 0), yielding=True),
    OptionKey('b_lto_mode'): coredata.UserComboOption('Select between different LTO modes.',
                                                      ['default', 'thin'],
                                                      'default',
                                                      yielding=True),
    OptionKey('b_thinlto_cache'): coredata.UserBooleanOption('Use LLVM ThinLTO caching for faster incremental builds', False, yielding=True),
    OptionKey('b_thinlto_cache_dir'): coredata.UserStringOption('Directory to store ThinLTO cache objects', '', yielding=True),
    OptionKey('b_sanitize'): coredata.UserComboOption('Code sanitizer to use',
                                                      ...
                                                      'none',
                                                      yielding=True),
    OptionKey('b_lundef'): coredata.UserBooleanOption('Use -Wl,--no-undefined when linking', True, yielding=True),
    OptionKey('b_asneeded'): coredata.UserBooleanOption('Use -Wl,--as-needed when linking', True, yielding=True),
    OptionKey('b_pgo'): coredata.UserComboOption('Use profile guided optimization',
                                                 ['off', 'generate', 'use'],
                                                 'off',
                                                 yielding=True),
    OptionKey('b_coverage'): coredata.UserBooleanOption('Enable coverage tracking.', False, yielding=True),
    OptionKey('b_colorout'): coredata.UserComboOption('Use colored output',
                                                      ['auto', 'always', 'never'],
                                                      'always',
                                                      yielding=True),
    OptionKey('b_ndebug'): coredata.UserComboOption('Disable asserts', ['true', 'false', 'if-release'], 'false', yielding=True),
    OptionKey('b_staticpic'): coredata.UserBooleanOption('Build static libraries as position independent', True, yielding=True),
    OptionKey('b_pie'): coredata.UserBooleanOption('Build executables as position independent', False, yielding=True),
    OptionKey('b_bitcode'): coredata.UserBooleanOption('Generate and embed bitcode (only macOS/iOS/tvOS)', False, yielding=True),
